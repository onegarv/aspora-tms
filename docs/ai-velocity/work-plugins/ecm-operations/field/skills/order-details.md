...
../shared/stuck-reasons.yaml           → Action, team, SLA, runbook
```
...
From `../shared/stuck-reasons.yaml`, get the entry for the `stuck_reason` returned by query.
...
### What To Do
{Numbered steps from ../shared/stuck-reasons.yaml action, expanded into clear instructions}
...
- Do NOT invent actions — use ../shared/stuck-reasons.yaml + templates above
